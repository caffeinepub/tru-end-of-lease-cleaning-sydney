...
export class Backend implements backendInterface {
    ...
    async submitEnquiry(arg0: string, arg1: string, arg2: string, arg3: ServiceType, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitEnquiry(arg0, arg1, arg2, to_candid_ServiceType_n6(this._uploadFile, this._downloadFile, arg3), arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    commercialClean: null;
} | {
    other: null;
} | {
    endOfLeaseClean: null;
} | {
    carpetClean: null;
}): ServiceType {
    return "commercialClean" in value ? ServiceType.commercialClean : "other" in value ? ServiceType.other : "endOfLeaseClean" in value ? ServiceType.endOfLeaseClean : "carpetClean" in value ? ServiceType.carpetClean : value;
}
...
function to_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ServiceType): {
    ...
    return value == ServiceType.commercialClean ? {
        commercialClean: null
    } : value == ServiceType.other ? {
        other: null
    } : value == ServiceType.endOfLeaseClean ? {
        endOfLeaseClean: null
    } : value == ServiceType.carpetClean ? {
        carpetClean: null
    } : value;
}
